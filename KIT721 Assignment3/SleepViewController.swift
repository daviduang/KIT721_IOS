...
class SleepViewController: UIViewController {
    ...
    @IBAction func saveTapped(_ sender: UIBarButtonItem) {
        ...
        let alertController = UIAlertController(title: "Save Sleep Event", message: "Do you want to create this new event?", preferredStyle: .alert)
            ...
            let confirmAction = UIAlertAction(title: "Confirm", style: .default) { _ in
                ...
                let newEvent = SleepEvent(documentID: nil,
                                         title: "Sleep Event",
    ...
    // Convert seconds to timer label view
